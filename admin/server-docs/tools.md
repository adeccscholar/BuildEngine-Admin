...
| `miktex` | 25.12 | managed, `when-used` | Compiles the LaTeX tree generated by Doxygen to PDF with `texify`. It does not trigger a second Doxygen run. |
...
Details about `WithDoxygen`, `WithLatex`, library overrides, and technical states are documented in [documentation.md](documentation.md).
