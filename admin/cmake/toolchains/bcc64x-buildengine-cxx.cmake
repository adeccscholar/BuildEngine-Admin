...
if(NOT DEFINED ENV{CB_BDS} OR "$ENV{CB_BDS}" STREQUAL "")
   message(FATAL_ERROR "CB_BDS is not set")
endif()
...
set(_BCC64X_COMPAT_INCLUDE "${_TP_CMAKE_ROOT}/compat/bcc64x")
...
list(PREPEND CMAKE_C_STANDARD_INCLUDE_DIRECTORIES "${_BCC64X_COMPAT_INCLUDE}")
list(PREPEND CMAKE_CXX_STANDARD_INCLUDE_DIRECTORIES "${_BCC64X_COMPAT_INCLUDE}")
